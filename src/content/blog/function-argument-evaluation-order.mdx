...
Unspecified behavior, according to [cppreference.com](https://en.cppreference.com), is defined to be when:
...
```c ins={"x86-64 clang 17.0.1":12-13} del={"x86-64 gcc 13.2":14-15}
#include <stdio.h>
